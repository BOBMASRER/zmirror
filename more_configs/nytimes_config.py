...
target_domain = 'www.nytimes.com'  # !!!!你的目标域名!!!!
target_scheme = 'https://'
...
domains_whitelist_auto_add_glob_list = ('*.nyt.com','*.nytimes.com','*.nytcn.net','*.datadome.co','*.line-scdn.net','*.cloudfront.net','nytcn.me')
external_domains = [
    "et.nytimes.com",
    "nytimes.com",
    "g1.nyt.com",
